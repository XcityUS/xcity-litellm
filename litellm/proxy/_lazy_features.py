...
LAZY_FEATURES: Tuple[LazyFeature, ...] = (
    ...
    LazyFeature(
        name="capabilities",
        module_path="litellm.proxy.capability_endpoints.capability_endpoints",
    ...
    LazyFeature(
        name="xct_context",
        module_path="litellm.proxy.context_endpoints.endpoints",
        path_prefixes=("/v1/xct-context",),
    ),
    LazyFeature(
        name="xct_marketplace",
        module_path="litellm.proxy.agent_endpoints.marketplace_config",
        path_prefixes=("/v1/xct-marketplace",),
    ),
    LazyFeature(
        name="xct_webhooks",
        module_path="litellm.proxy.webhook_endpoints.endpoints",
    ...
    LazyFeature(
        name="xct_oauth",
        module_path="litellm.proxy.xct_oauth_endpoints.oauth_endpoints",
        path_prefixes=("/oauth/",),
    ),
    LazyFeature(
        name="gemini_agents",
