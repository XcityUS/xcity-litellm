...
async def get_agents(
    ...
    q: Optional[str] = Query(None, description="Free-text match against agent name + description."),
    ...
    cursor: Optional[str] = Query(None, description="agent_id of the previous page tail for cursor pagination."),
...
async def list_agent_versions_endpoint(
    ...
    cursor: Optional[str] = Query(None, description="version_id of the prev page tail."),
    user_api_key_dict: UserAPIKeyAuth = Depends(user_api_key_auth),
) -> List[Dict[str, Any]]:
