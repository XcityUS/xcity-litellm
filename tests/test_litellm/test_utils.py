    ...
    INTENDED_SCHEMA = {
        ...
        "additionalProperties": {
            ...
            "properties": {
                ...
                "output_cost_per_video_token_480p": {"type": "number"},
                "output_cost_per_video_token_480p_with_video": {"type": "number"},
                "output_cost_per_video_token_720p": {"type": "number"},
                "output_cost_per_video_token_720p_with_video": {"type": "number"},
                "output_cost_per_video_token_1080p": {"type": "number"},
                "output_cost_per_video_token_1080p_with_video": {"type": "number"},
                "output_cost_per_video_token_4k": {"type": "number"},
                "output_cost_per_video_token_4k_with_video": {"type": "number"},
...
def test_supports_tool_choice_simple_tests():
    ...
    assert litellm.utils.supports_tool_choice(model="us.amazon.nova-micro-v1:0") is True
    assert litellm.utils.supports_tool_choice(model="bedrock/us.amazon.nova-micro-v1:0") is True
    assert (
